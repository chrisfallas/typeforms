 ...
 */
declare const FormProvider: <T extends Record<string, any> = Record<string, any>>({ customFormId, initialValues, schemaValidation, onChange, onSubmit, render, children, }: PropsWithChildren<FormProviderProps<T> & RenderProp<FormContextValues<T>>>) => import("react/jsx-runtime").JSX.Element;
